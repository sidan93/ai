...
## Связанные концепции
- [[Multi-Agent Systems|Мультиагентные системы]] — когда несколько агентов работают вместе.
- [[Tool Use Function Calling|Tool Use (Function Calling)]] — механизм, с помощью которого агент действует.
- [[Анатомия Агента]] — детальный разбор цикла: планирование, память, инструменты, оценка.
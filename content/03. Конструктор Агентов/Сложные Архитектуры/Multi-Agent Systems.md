...
> [!tip] Совет для Вики
> Используйте агента **"Archivist"**. Его единственная роль — анализировать ваши новые заметки и предлагать, в какие существующие папки их положить и с какими `[[заметками]]` связать.

...
2. **Execute (Выполнение):** Проверь результат на нескольких доступных моделях, если переносимость действительно важна.
...
* **Лог ошибок:** Если модель систематически ошибается, веди журнал ошибок с примерами, причиной и проверенным способом предотвращения.
...
- [[_Prompt Lab Index]] — библиотека проверяемых шаблонов.
